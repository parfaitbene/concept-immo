...
@NgModule({
  ...
  providers: [UserService, AuthGuard, StorageService, AppConfig, CategoryService, TabService, StatusBar, ScreenOrientation, { provide: RouteReuseStrategy, useClass: IonicRouteStrategy, }],
